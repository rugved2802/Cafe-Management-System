...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1450, 40, 50, 51));
        ...
        txtNamelabel.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        txtNamelabel.setText("Name:");
        getContentPane().add(txtNamelabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, -1, -1));

        txtCusName.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        txtCusName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusNameKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 300, -1));
        ...
        txtCusMobile.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        txtCusMobile.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusMobileKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusMobile, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 300, -1));
        ...
        txtCusEmail.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        txtCusEmail.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusEmailKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 540, 300, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 220, 300, -1));

        jLabel8.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel8.setText("Search:");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 280, -1, -1));

        txtSearch.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        txtSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtSearchKeyReleased(evt);
            }
        });
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 330, 300, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 380, 300, 316));
        ...
        txtProductName.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        getContentPane().add(txtProductName, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 220, 300, -1));

        jLabel10.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel10.setText("Price:");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 170, -1, -1));

        txtPrice.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        getContentPane().add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 220, 300, -1));
        ...
        jSpinner1.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jSpinner1.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jSpinner1StateChanged(evt);
            }
        });
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 330, 300, -1));

        jLabel12.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel12.setText("Total:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 280, -1, -1));

        txtTotal.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        getContentPane().add(txtTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 330, 300, -1));

        btnClear.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 380, -1, -1));

        btnAddtoCart.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        ...
        getContentPane().add(btnAddtoCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1330, 380, -1, -1));

        jTable2.setFont(new java.awt.Font("Yu Gothic UI", 1, 14)); // NOI18N
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 440, 680, 257));

        btnBill.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        ...
        getContentPane().add(btnBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 720, -1, -1));

        jLabel13.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Grand Total: Rs.");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 720, -1, -1));

        lblgrandTotal.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        lblgrandTotal.setForeground(new java.awt.Color(255, 255, 255));
        lblgrandTotal.setText("000");
        getContentPane().add(lblgrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 720, 43, -1));

        jLabel5.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel5.setText("--");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 37, -1));

        jLabel15.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel15.setText("--");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 170, 43, -1));

        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fullpage.png"))); // NOI18N
    ...
    private void btnBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBillActionPerformed
        ...
        //Creating document
        String path = "D:\\codes\\generated bills\\";
