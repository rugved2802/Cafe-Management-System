...
public class ViewBillsOrderPlacedDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1470, 20, 43, 43));

        jLabel2.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel2.setText("Filter By Date:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(287, 142, -1, -1));

        jLabel3.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel3.setText("Change Order by ID:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 142, -1, -1));

        jTextField1.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jTextField1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextField1KeyReleased(evt);
            }
        });
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(432, 142, 300, -1));

        jComboBox1.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1014, 142, 300, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 193, 1504, 610));

        jLabel4.setFont(new java.awt.Font("Yu Gothic UI", 1, 20)); // NOI18N
        jLabel4.setText("*Click on row to open Bill");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 810, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fullpage.png"))); // NOI18N
